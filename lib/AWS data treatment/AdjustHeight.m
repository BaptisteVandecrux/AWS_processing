...
%% load maintenance data
    ...
    [H_1_ts_smoothed] = PrepairSurfaceHeight(H_1_ts,hampel_period,hampel_var);
    [H_2_ts_smoothed] = PrepairSurfaceHeight(H_2_ts,hampel_period,hampel_var);
...
%% applying shifts to rconstruct surface height
    H_1_ts_new = H_1_ts_smoothed;
    H_2_ts_new = H_2_ts_smoothed;
...
%% plot surface height adjustment process
    ...
    dH1 = NaN*H_1_ts_new.Data;
    dH2 = NaN*H_2_ts_new.Data;
        
    dH1(2:end) = H_1_ts_new.Data(2:end)-H_1_ts_new.Data(1:end-1);
%     dH1(isnan(dH1)) = 0;
    dH2(2:end) = H_2_ts_new.Data(2:end)-H_2_ts_new.Data(1:end-1);
...
%     dH2 = NaN*H_2_ts_new.Data;
    ...
    H_merged = cumsum(aux);
    H_merged(isnan(nanmean([H_1_ts_new.Data ,H_2_ts_new.Data],2)))= NaN;
    ...
    for i = 1:length(is_end_of_gap)
        H_merged(is_end_of_gap(i):end) = H_merged(is_end_of_gap(i):end) - H_merged(is_end_of_gap(i)) ...
            + nanmean([H_1_ts_new.Data(is_end_of_gap(i)),H_2_ts_new.Data(is_end_of_gap(i))]);
    end
...
%     plot(H_merged)
%     pause
%     plot(H_1_ts_new.Data)
%     pause
%     plot(H_2_ts_new.Data)
%     plot(dH1*100)
%     plot(dH2*100)
%     plot(aux*100+16)

...
%         legend('Hourly data','Daily data used to fill the gaps')
    ...
    data.WindSensorHeight2m = NaN(size(data.AirTemperature1C));
    data.TemperatureSensorHeight2m = NaN(size(data.AirTemperature1C));
    data.HumiditySensorHeight2m = NaN(size(data.AirTemperature1C));
    data.AirTemperature2C = NaN(size(data.AirTemperature1C));
    data.AirTemperature4C = NaN(size(data.AirTemperature1C));
    data.RelativeHumidity2Perc = NaN(size(data.RelativeHumidity1Perc));
    data.NetRadiationWm2 = NaN(size(data.RelativeHumidity1Perc));
    data.WindSpeed2ms = NaN(size(data.RelativeHumidity1Perc));
    data.WindDirection2deg = NaN(size(data.RelativeHumidity1Perc));
